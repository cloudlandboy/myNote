- 乐优商城
  ...
  - [Elasticsearch](/#/backend/elasticsearch/elasticsearch.md ' :ignore :target=_blank')
  - [Spring Data Elasticsearch](/#/backend/elasticsearch/springdata-elasticsearch ':ignore :target=_blank')
  - [基本商品搜索](project/leyoumall/basi-search.md)
  - [商品搜索过滤](project/leyoumall/search-filter.md)
  - [商品详情和静态化](project/leyoumall/goods-info.md)
  - [rabbitmq的安装](/#/backend/rabbitmq/rabbitmq-install.md ' :ignore :target=_blank')
  - [RabbitMQ和数据同步](/#/backend/rabbitmq/rabbitmq-data-sync.md ' :ignore :target=_blank')
