...
1. 将静态资源(css,img,js)添加到项目中，放到springboot[默认的静态资源文件夹下](java/springboot/helloweb?id=非webjars，自己的静态资源怎么访问)
2. 将模板文件(html)放到[template文件夹下](java/springboot/templateengine?id=thymeleaf%e4%bd%bf%e7%94%a8)

![1573896827010](https://cdn.tencentfs.clboy.cn/images/2021/20210911203226245.png)
...
> 国际化也称作i18n，其来源是英文单词 **internationalization** 的首末字符i和n，18为中间的字符数。由于软件发行可能面向多个国家，对于不同国家的用户，软件显示不同语言的过程就是国际化（举个例子，人们玩的电子游戏，通常可以选择多个语言版本，适应于多个国家的玩家）。通常来讲，软件中的国际化是通过配置文件来实现的，假设某个软件要支撑两种语言，那么就需要两个版本的配置文件。
>
...
1. 编写国际化配置文件，抽取页面需要显示的国际化消息
   ...
   ![1573900332686](https://cdn.tencentfs.clboy.cn/images/2021/20210911203226699.png)
...
2. 在配置文件中添加国际化文件的位置和基础名
   ...
   如果配置文件中没有配置基础名，就在类路径下找基础名为`messages`的配置文件
...
4. 然后就可以更改浏览器语言，页面就会使用对应的国际化配置文件
      ...
      ![1573900071209](https://cdn.tencentfs.clboy.cn/images/2021/20210911203226470.png)
...
1. 点击删除提交发出delete请求
   ...
   ![1573987255217](https://cdn.tencentfs.clboy.cn/images/2021/20210911203226927.png)

   这个好像是2.0版本以后修改的

   ![1573988088629](https://cdn.tencentfs.clboy.cn/images/2021/20210911203227165.png)
