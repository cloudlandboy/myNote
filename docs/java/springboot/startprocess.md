...
2. 创建SpringApplication
   ...
   ![1574499682826](https://cdn.tencentfs.clboy.cn/images/2021/20210911203233952.png)
      ...
      ![1574501479198](https://cdn.tencentfs.clboy.cn/images/2021/20210911203234141.png)

      然后再调用`getOrDefault(factoryTypeName, Collections.emptyList())`方法，获取key为

      `ApplicationContextInitializer`类名的value集合

      ![1574501635588](https://cdn.tencentfs.clboy.cn/images/2021/20210911203234324.png)
   ...
   ![1574502740682](https://cdn.tencentfs.clboy.cn/images/2021/20210911203234507.png)
...
3. 调用SpringApplication对象的run方法
   ...
   [onRefresh方法](https://cloudlandboy.github.io/#/java/springboot/configservletcontainer?id=%e5%b5%8c%e5%85%a5%e5%bc%8fservlet%e5%ae%b9%e5%99%a8%e5%90%af%e5%8a%a8%e5%8e%9f%e7%90%86)
