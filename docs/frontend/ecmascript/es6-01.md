...
- `endsWith(str)`：返回布尔值，表示参数字符串是否在原字符串的尾部。
 ...
 ![1526107640349](https://cdn.tencentfs.clboy.cn/images/2021/20210911203211630.png)
...
```
  ...
  ![1526110796839](https://cdn.tencentfs.clboy.cn/images/2021/20210911203213727.png)
...
没有初始值：
 ...
 ![1526111537204](https://cdn.tencentfs.clboy.cn/images/2021/20210911203218317.png)

指定初始值：

![1575032880565](https://cdn.tencentfs.clboy.cn/images/2021/20210911203218644.png)
...
- assign(dest, ...src) ：将多个src对象的值 拷贝到 dest中（浅拷贝）。
 ...
 ![1527210872966](https://cdn.tencentfs.clboy.cn/images/2021/20210911203215419.png)
