...
![1531753066475](https://cdn.static.zzrfdsn.cn/images/elsearch/1531753066475.png)
...
![1531753715580](https://cdn.static.zzrfdsn.cn/images/elsearch/1531753715580.png)



Spring Data Elasticsearch的页面：https://projects.spring.io/spring-data-elasticsearch/

 ![1531754111583](https://cdn.static.zzrfdsn.cn/images/elsearch/1531754111583.png)
...
![1575780014488](https://cdn.static.zzrfdsn.cn/images/elsearch/1575780014488.png)
...
![1531984923727](https://cdn.static.zzrfdsn.cn/images/elsearch/1531984923727.png)
...
![1531985337698](https://cdn.static.zzrfdsn.cn/images/elsearch/1531985337698.png)
...
![1575782741796](https://cdn.static.zzrfdsn.cn/images/elsearch/1575782741796.png)
...
![1526544759120](https://cdn.static.zzrfdsn.cn/images/elsearch/1531986474606.png)
...
![1575782866354](https://cdn.static.zzrfdsn.cn/images/elsearch/1575782866354.png)
...
我们只需要定义接口，然后继承它就OK了。
 ...
 ![1531987244855](https://cdn.static.zzrfdsn.cn/images/elsearch/1531987244855.png)
...
来看下Repository的继承关系：
 ...
 ![1531986965570](https://cdn.static.zzrfdsn.cn/images/elsearch/1531986965570.png)

我们看到有一个ElasticsearchRepository接口：

![1531987044693](https://cdn.static.zzrfdsn.cn/images/elsearch/1531987044693.png)
...
![1575783245049](https://cdn.static.zzrfdsn.cn/images/elsearch/1575783245049.png)
...
![1531990510740](https://cdn.static.zzrfdsn.cn/images/elsearch/1531990510740.png)
...
Repository的search方法需要QueryBuilder参数，elasticSearch为我们提供了一个对象QueryBuilders：
 ...
 ![1532008212626](https://cdn.static.zzrfdsn.cn/images/elsearch/1532008212626.png)
...
![1532009679148](https://cdn.static.zzrfdsn.cn/images/elsearch/1532009679148.png)
...
- `AggregationBuilders`：聚合的构建工厂类。所有聚合都由这个类来构建，看看他的静态方法：
  ...
  ![1526567597724](https://cdn.static.zzrfdsn.cn/images/elsearch/1526567597724.png)

- `AggregatedPage`：聚合查询的结果类。它是`Page<T>`的子接口：

  ![1526567748355](https://cdn.static.zzrfdsn.cn/images/elsearch/1526567748355.png)

  `AggregatedPage`在`Page`功能的基础上，拓展了与聚合相关的功能，它其实就是对聚合结果的一种封装，大家可以对照聚合结果的JSON结构来看。

   ![1526567889455](https://cdn.static.zzrfdsn.cn/images/elsearch/1526567889455.png)

  而返回的结果都是Aggregation类型对象，不过根据字段类型不同，又有不同的子类表示

   ![1526568128210](https://cdn.static.zzrfdsn.cn/images/elsearch/1526568128210.png)



我们看下页面的查询的JSON结果与Java类的对照关系：

 ![1526571200130](https://cdn.static.zzrfdsn.cn/images/elsearch/1526571200130.png)
