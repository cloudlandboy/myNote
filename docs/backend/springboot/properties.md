...
![提示](https://cdn.staticzzrfdsn.cn/images/springboot/assets/1573648927366.png)
...
![乱码解决](https://cdn.staticzzrfdsn.cn/images/springboot/assets/1573695616496.png)
...
![数据校验](https://cdn.staticzzrfdsn.cn/images/springboot/assets/1573716216690.png)

`@value`注解不支持数据校验

![数据校验](https://cdn.staticzzrfdsn.cn/images/springboot/assets/1573716427494.png)
...
![1573716770263](https://cdn.staticzzrfdsn.cn/images/springboot/assets/1573716770263.png)
...
![1573718577827](https://cdn.staticzzrfdsn.cn/images/springboot/assets/1573718577827.png)

使用`@PropertySource({"classpath:person.properties"})`指定加载`person.properties`配置文件

![1573718679208](https://cdn.staticzzrfdsn.cn/images/springboot/assets/1573718679208.png)
...
![1573719440710](https://cdn.staticzzrfdsn.cn/images/springboot/assets/1573719440710.png)



想让Spring的配置文件生效，加载进来；@**ImportResource**标注在一个配置类上

![1573720006428](https://cdn.staticzzrfdsn.cn/images/springboot/assets/1573720006428.png)
...
![1573721695426](https://cdn.staticzzrfdsn.cn/images/springboot/assets/1573721695426.png)



可以引用在配置文件中配置的其他属性的值，如果使用一个没有在配置文件中的属性，则会原样输出

![1573722018302](https://cdn.staticzzrfdsn.cn/images/springboot/assets/1573722018302.png)

可以使用`:`指定默认值

![1573722098119](https://cdn.staticzzrfdsn.cn/images/springboot/assets/1573722098119.png)
...
![1573723830627](https://cdn.staticzzrfdsn.cn/images/springboot/assets/1573723830627.png)

程序启动时会默认加载`application.properties`，启动的端口就是8080

可以在主配置文件中指定激活哪个配置文件

![1573724084979](https://cdn.staticzzrfdsn.cn/images/springboot/assets/1573724084979.png)
...
![1573724588671](https://cdn.staticzzrfdsn.cn/images/springboot/assets/1573724588671.png)
...
2. 项目打包后在命令行启动
   ...
   ![1573724952868](https://cdn.staticzzrfdsn.cn/images/springboot/assets/1573724952868.png)
...
3. 虚拟机参数
   ...
   ![1573725631649](https://cdn.staticzzrfdsn.cn/images/springboot/assets/1573725631649.png)
...
![1573728449451](https://cdn.staticzzrfdsn.cn/images/springboot/assets/1573728449451.png)
...
![1573735371567](https://cdn.staticzzrfdsn.cn/images/springboot/assets/1573735371567.png)